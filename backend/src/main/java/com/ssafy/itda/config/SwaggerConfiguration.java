...
//    http://localhost:8000/itda/swagger-ui.html
...
public Docket api() {
    ...
    return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(version).select()
                .apis(RequestHandlerSelectors.basePackage("com.ssafy.itda.controller"))
...
private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title(title)
            .description("<h3>SSAFY API Reference for Developers</h3>Swagger를 이용한 VUEJS API<br>")
            .version("1.0").build();
